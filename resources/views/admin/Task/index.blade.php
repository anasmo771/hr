...
<div class="pc-container">
  <div class="pc-content">
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">التكليفات</li>
            </ul>
          </div>
          <div class="col-6">
            <div class="page-header-title"><h2 class="mb-0">التكليفات</h2></div>
          </div>
          <div class="col-6">
            <div class="text-sm-end">
              <a href="{{ route('tasks.createNew') }}" class="btn btn-primary" style="color: white; float: left;">إضـــافــة تـكـلـيـف</a>
            </div>
          </div>
        </div>
      </div>
              ...
              <table class="table align-middle table-nowrap table-hover">
                <thead class="table-light">
                  <tr>
                    ...
                    <th class="text-center">ملاحظات</th>      <!-- note -->
    ...
    @else
      <div class="row">
        <div class="col-lg-12">
          <h4 class="mb-sm-0 text-center font-size-18">لا يــوجــد تـكـلـيـف</h4>
        </div>
      </div>
    @endif
  </div>
