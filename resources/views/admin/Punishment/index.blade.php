        ...
        <div class="row align-items-center">
          ...
          <div class="col-6">
            <div class="page-header-title">
              <h2 class="mb-0">العـقـوبـات</h2>
            </div>
          </div>
          <div class="col-6">
            <div class="text-sm-end">
              <a href="{{ route('punishments.createNew') }}" class="btn btn-primary" style="color: white; float: left;">إضـــافــة عـقـوبـة</a>
            </div>
          </div><!-- end col-->
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <form action="{{ route('searchEmployeePunshe') }}" method="get" class="px-3 py-2">
              @csrf
              <div class="row align-items-center">
                <div class="col-lg-5">
                  <div class="input-group input-group-sm">
                    <input type="text" name="name" class="form-control rounded-start-pill" placeholder="البحث عن موظف" aria-label="Search">
            ...
            <div class="card-body px-3 py-2">
              <div class="form-group m-0 p-0 d-inline-block">
                <a href="{{ route('punishment.print') }}" target="_blank"
                   class="btn btn-outline-primary btn-sm rounded-pill d-flex align-items-center px-3 py-1 ms-2">
                        ...
                        <td class="text-center col-lg-2">
                          <ul class="list-inline mb-0">
                            <li class="list-inline-item">
                              <a href="{{ route('punishments.edit', [$punsh->id]) }}" class="btn btn-sm btn-primary" title="تعديل">
                                <i class="mdi mdi-pencil"></i>
                              </a>
                            </li>
                            <li class="list-inline-item">
                              <form method="POST" action="{{ route('punishments.destroy', [$punsh->id]) }}" onsubmit="return confirm('هل أنت متأكد من الحذف؟');">
                                @csrf
                                @method('DELETE')
