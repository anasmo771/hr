                    ...
                    <div class="pc-content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">دورة جـديـدة </li>
                                        </ul>
                                    </div>
                                    <div class="col-12">
                                        <div class="page-header-title">
                                            <h2 class="mb-0">دورة جـديـدة</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <h4 class="card-title">تـقـديـم دورة جـديـدة</h4>


                                        <!-- <p class="card-title-desc">Fill all information below</p> -->

                                        <form action="{{route('courses.store',['id'=>0])}}" method="post" enctype="multipart/form-data" id="form">
                                          @csrf
                                          <div class="row mt-3">

                                            {{-- <div class="col-sm-4">
                                                <label for="worktitle" class="col-form-label col-lg-4" style="font-size:140%;">الـمـوظــفـ <span><i class="fa fa-caret-down" aria-hidden="true"></i></span> </label>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        <label for="worktitle" class="col-form-label col-lg-4" style="font-size:100%;">اســم الدورة</label>
                                                        <input id="fullname"  name="course_name" type="text" class="form-control" placeholder="اسم الدورة" required oninvalid="this.setCustomValidity('الرجاء ادخال اسم الدورة')"  oninput="this.setCustomValidity('')">
                                                ...
                                                <div class="col-lg-4">
                                                    <label for="worktitle" class="col-form-label col-lg-4" style="font-size:100%;">نـوع
                                                        الدورة</label>
                                                    <select name="course_type"class="form-control"
                                                        lang="ar" required
                                                        oninvalid="this.setCustomValidity('الرجاء تحديد نوع الدورة')"
                                                        oninput="this.setCustomValidity('')">
                                                        <option selected disabled>الرجاء تحديد نوع الدورة</option>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        <label for="worktitle" class="col-form-label col-lg-4" style="font-size:100%;">تاريــخ البداية</label>
                                                        <input id="startDate" name="from_date" type="text" oninput="dateValidation(this)" placeholder="YYYY-MM-DD" class="form-control" required oninvalid="this.setCustomValidity('الرجاء ادخال تاريخ البداية')" oninput="this.setCustomValidity('')">
                                                    </div>
                                                </div>

                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        <label for="worktitle" class="col-form-label col-lg-4" style="font-size:100%;">تاريــخ النهاية</label>
                                                        <input id="earnDate" name="to_date" type="text" class="form-control"  oninput="dateValidation(this)" placeholder="YYYY-MM-DD" required oninvalid="this.setCustomValidity('الرجاء ادخال تاريخ النهاية')"  oninput="this.setCustomValidity('')">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        <label for="worktitle" class="col-form-label col-lg-4" style="font-size:100%;">الـجـهـة الـمـنـفـدة</label>
                                                        <input id="" name="agency" type="text" class="form-control" placeholder="الـجـهـة الـمنـفدة" required oninvalid="this.setCustomValidity('الرجاء ادخال الجهة المنفدة')"  oninput="this.setCustomValidity('')">
                                                    </div>
                                                </div>

                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        <label for="worktitle" class="col-form-label col-lg-4" style="font-size:100%;">مـكـان الـدورة</label>
                                                        <input id="" name="place" type="text" class="form-control" placeholder="مـكـان الـدورة" required oninvalid="this.setCustomValidity('الرجاء ادخال مـكـان الـدورة')"  oninput="this.setCustomValidity('')">
                                                    </div>
                                                </div>

                                                <div class="col-sm-4">
                                                    <div class="mb-3">
                                                        <label for="worktitle" class="col-form-label col-lg-4" style="font-size:100%;">رقـم الـقـرار </label>
                                                        <input id="" name="number" type="text" class="form-control" placeholder="رقـم القــرار" required oninvalid="this.setCustomValidity('الرجاء ادخال رقـم القــرار')"  oninput="this.setCustomValidity('')">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <label for="worktitle" class="col-form-label" style="font-size:100%;">ملاحـظـات  (اختياري) </label>
