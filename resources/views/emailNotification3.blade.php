...
<div class="container px-1 px-md-4 py-5 mx-auto" dir="rtl">
    ...
    <div style="text-align: center; margin-top: -30px; margin-bottom: -80px;">
        ...
        <div class="row d-flex justify-content-center">
            <div class="d-flex text-sm-center text-center" style="text-align: center !important; font-family: 'Amiri'; font-size: 30px; padding-top: 35px;" >
                <a href="{{route('login')}}" style="text-decoration:none;"><p> <span style="color: #555fcf;" class="font-weight-bold">نـظـام إدارة شـؤون الـمـوظـفـيين </span></p></a><br>
            </div>
        </div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="d-flex text-sm-center text-center" style="text-align: center !important; font-family: 'Amiri'; font-size: 25px;" >
               <p> مرحبآ <span style="color: #555fcf;"> مدير </span> </p> <br>
            </div>
        </div>

        <div class="row d-flex justify-content-center"style="padding-top: -50px;" >
            <div class="d-flex text-sm-center text-center" style="text-align: center !important; font-family: 'Amiri'; font-size: 25px;" >
                <p> طلبات التسوية المالة للموظفين بتاريخ {{now()->format('Y-m-d')}}</p><br>
            </div>
        </div>
                        ...
                        <div class="">
                            <table dir="rtl" style="border-collapse: white;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <h5 class="font-size-14 mb-1"><a href="javascript: void(0);" class="text-dark">{{$emp["name"]}}</a></h5>
                                        </td>
                                        <td>{{$emp["nid"]}}</td>
                                        <td>{{$emp["degree"]}}</td>
                                        <td>{{$emp["date"]}}</td>
        ...
        <div class="row d-flex justify-content-center">
            <div class="d-flex text-sm-center text-center" style="text-align: center !important; font-family: 'Amiri'; font-size: 25px; padding-bottom: 50px; color: white;" >
				<a href="{{route('home')}}" class="btn btn-dark float-center veiwbutton" style="font-family: 'Amiri'; font-size: 20px; color: white;">الدخول الان</a>
            </div>
        </div>
